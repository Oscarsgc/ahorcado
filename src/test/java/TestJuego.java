...
public class TestJuego {
	...
	@Test
	public void muestraMensajeDeErrorSiLetraNoExiste() {
		assertEquals("Letra no encontrada!", juego.ingresarLetra('x'));
	}

	@Test
	public void probarSeleccionPalabraAleatoriaDeDiccionarioConParametros() {
		Juego j = new Juego();
		j.obtenerPalabraDeDiccionario(1, "Paises");
